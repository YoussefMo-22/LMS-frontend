...
const StudentDashboardLayout: React.FC = () => {
  ...
  const navigationItems = [
    { name: 'Overview', href: '/student-dashboard', icon: Home, badge: null },
    { name: 'My Courses', href: '/student-dashboard/courses', icon: BookOpen, badge: null },
    { name: 'Assignments', href: '/student-dashboard/assignments', icon: FileText, badge: null },
    { name: 'Submissions', href: '/student-dashboard/submissions', icon: Upload, badge: null },
    { name: 'Certificates', href: '/student-dashboard/certificates', icon: Award, badge: null },
    { name: 'Messages', href: '/student-dashboard/messages', icon: MessageSquare, badge: null },
    { name: 'Progress', href: '/student-dashboard/progress', icon: BarChart3, badge: null },
    { name: 'Calendar', href: '/student-dashboard/calendar', icon: Calendar, badge: null },
    { name: 'Settings', href: '/student-dashboard/settings', icon: Settings, badge: null },
  ];
            ...
            <div className="flex items-center px-4 py-3 rounded-xl bg-primary-500">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-primary-200 truncate">
                  {user?.email || "student@levelup.com"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden lg:flex items-center space-x-2">
                <Link
                  to="/courses"
                  className="flex items-center px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm font-medium"
                >
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg z-50 py-2">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-sm text-gray-500">{user?.email || "student@levelup.com"}</p>
                    </div>
                    <div className="py-1">
                      <Link
                        to="/profile"
