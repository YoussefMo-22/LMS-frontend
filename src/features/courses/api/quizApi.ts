...
export const quizApi = {
  ...
  getCourseQuizzes: (courseId: string): Promise<any> =>
    axiosInstance.get(`quizzes/course/${courseId}`).then(res => res.data),
  ...
  getQuizzes: (params?: any): Promise<any> =>
    axiosInstance.get('quizzes', { params }).then(res => res.data),

  // Update Quiz
  updateQuiz: (quizId: string, data: any): Promise<any> =>
    axiosInstance.put(`quizzes/${quizId}`, data).then(res => res.data),

  // Delete Quiz
  deleteQuiz: (quizId: string): Promise<any> =>
    axiosInstance.delete(`quizzes/${quizId}`).then(res => res.data),
  ...
  addQuizQuestion: (quizId: string, data: any): Promise<any> =>
    axiosInstance.post(`quizzes/${quizId}/questions`, data).then(res => res.data),

  // Update Quiz Question
  updateQuizQuestion: (quizId: string, questionId: string, data: any): Promise<any> =>
    axiosInstance.put(`quizzes/${quizId}/questions/${questionId}`, data).then(res => res.data),

  // Delete Quiz Question
  deleteQuizQuestion: (quizId: string, questionId: string): Promise<any> =>
    axiosInstance.delete(`quizzes/${quizId}/questions/${questionId}`).then(res => res.data),

  // Submit Quiz Attempt
  submitQuizAttempt: (quizId: string, data: any): Promise<any> =>
    axiosInstance.post(`quizzes/${quizId}/attempt`, data).then(res => res.data),

  // Get Quiz Attempts
  getQuizAttempts: (quizId: string): Promise<any> =>
    axiosInstance.get(`quizzes/${quizId}/attempts`).then(res => res.data),

  // Get My Quiz Attempts
  getMyQuizAttempts: (quizId: string): Promise<any> =>
    axiosInstance.get(`quizzes/${quizId}/my-attempts`).then(res => res.data),

  // Get Quiz Results
  getQuizResults: (attemptId: string): Promise<any> =>
    axiosInstance.get(`quiz-attempts/${attemptId}/results`).then(res => res.data),
};
