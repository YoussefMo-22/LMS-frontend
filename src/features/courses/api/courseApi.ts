...
export const courseApi = {
  ...
  getInstructorCourse: (id: string) =>
    axiosInstance.get(`courses/${id}/forinstructor`).then(res => res.data),
  ...
  updateInstructorCourse: (id: string, data: UpdateCourseData) =>
    axiosInstance.patch(`courses/${id}`, data).then(res => res.data),
  ...
  getAdminCourses: (filters: CourseFilters) =>
    axiosInstance.get('courses/foradmin', { params: filters }).then(res => res.data),

  // Get single admin course
  getAdminCourse: (id: string) =>
    axiosInstance.get(`courses/${id}/foradmin`).then(res => res.data),

  // Update admin course
  updateAdminCourse: (id: string, data: UpdateCourseData) =>
    axiosInstance.patch(`courses/${id}/foradmin`, data).then(res => res.data),

  // Delete admin course
  deleteAdminCourse: (id: string) =>
    axiosInstance.delete(`courses/${id}/foradmin`).then(res => res.data),

  // Get course statistics
  getCourseStats: (id: string) =>
    axiosInstance.get(`courses/${id}/stats`).then(res => res.data),

  // Get course enrollments
  getCourseEnrollments: (id: string) =>
    axiosInstance.get(`courses/${id}/enrollments`).then(res => res.data),

  // Get course reviews
  getCourseReviews: (id: string) =>
    axiosInstance.get(`courses/${id}/reviews`).then(res => res.data),

  // Get course average rating
  getCourseAverageRating: (id: string) =>
    axiosInstance.get(`review/course/${id}/average`).then(res => res.data),

  // Add course review
  addCourseReview: (id: string, data: { rating: number; comment: string }) =>
    axiosInstance.post(`courses/${id}/reviews`, data).then(res => res.data),

  // Update course review
  updateCourseReview: (courseId: string, reviewId: string, data: { rating: number; comment: string }) =>
    axiosInstance.put(`courses/${courseId}/reviews/${reviewId}`, data).then(res => res.data),

  // Delete course review
  deleteCourseReview: (courseId: string, reviewId: string) =>
    axiosInstance.delete(`courses/${courseId}/reviews/${reviewId}`).then(res => res.data),

  // Get course lessons
  getCourseLessons: (id: string) =>
    axiosInstance.get(`courses/${id}/lessons`).then(res => res.data),

  // Get single lesson
  getLesson: (id: string) =>
    axiosInstance.get(`lessons/${id}`).then(res => res.data),

  // Mark lesson as complete
  markLessonComplete: (id: string) =>
    axiosInstance.post(`lessons/${id}/mark`).then(res => res.data),

  // Get course assignments
  getCourseAssignments: (id: string) =>
    axiosInstance.get(`courses/${id}/assignments`).then(res => res.data),
  ...
  getCourseQuizzes: (id: string) =>
    axiosInstance.get(`courses/${id}/quizzes`).then(res => res.data),
  ...
  getCourseLiveSessions: (id: string) =>
    axiosInstance.get(`courses/${id}/live-sessions`).then(res => res.data),

  // Enroll in course
  enrollInCourse: (id: string, data?: { couponCode?: string }) =>
    axiosInstance.post(`courses/${id}/enroll`, data).then(res => res.data),

  // Unenroll from course
  unenrollFromCourse: (id: string) =>
    axiosInstance.delete(`courses/${id}/enroll`).then(res => res.data),

  // Get course progress
  getCourseProgress: (id: string) =>
    axiosInstance.get(`courses/${id}/progress`).then(res => res.data),

  // Update course progress
  updateCourseProgress: (id: string, data: { lessonId: string; completed: boolean }) =>
    axiosInstance.post(`courses/${id}/progress`, data).then(res => res.data),

  // Get course certificate
  getCourseCertificate: (id: string) =>
    axiosInstance.get(`courses/${id}/certificate`).then(res => res.data),
  ...
  getCourseRecommendations: (id: string) =>
    axiosInstance.get(`courses/${id}/recommendations`).then(res => res.data),

  // Search courses
  searchCourses: (query: string, filters?: CourseFilters) =>
    axiosInstance.get('courses/search', { params: { q: query, ...filters } }).then(res => res.data),

  // Get popular courses
  getPopularCourses: () =>
    axiosInstance.get('courses/popular').then(res => res.data),

  // Get featured courses
  getFeaturedCourses: () =>
    axiosInstance.get('courses/featured').then(res => res.data),

  // Get new courses
  getNewCourses: () =>
    axiosInstance.get('courses/new').then(res => res.data),
