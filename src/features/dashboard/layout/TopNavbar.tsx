...
export default function TopNavbar({ user, onLogout }: NavbarLoginProps) {
  ...
  return (
    <header className="bg-white shadow px-8 py-4 flex items-center justify-between">
      <div className="text-2xl font-bold text-primary-500 tracking-tight">Dashboard</div>
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          />
          <span className="font-medium text-gray-700">{user?.name || user?.email || "User"}</span>
